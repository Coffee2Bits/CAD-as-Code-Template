...
class TestArtifactDiscovery:
    def test_sphere_with_nut_artifact_discovered(self, registry):
...
class TestSphereWithNutAssembly:
    def test_sphere_with_nut_assembly_has_colored_children(self):
    ...
    def test_sphere_with_nut_exports(self, tmp_path):
